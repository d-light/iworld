...
$lang['store_goods_index_belong_multiple_store_class']	= '商品可以从属于店铺的多个分类之下，店铺分类可以由 "商家中心 -> 店铺 -> 店铺分类" 中自定义';
...
$lang['store_goods_index_goods_stock_help']		= '商铺库存数量必须为0~999999999之间的整数<br/>若启用了库存配置，则系统自动计算商品的总数，此处无需卖家填写';
...
$lang['store_goods_index_goods_no_help']		= '商家货号是指商家管理商品的编号，买家不可见<br/>最多可输入20个字符，支持输入中文、字母、数字、_、/、-和小数点';
...
$lang['store_goods_index_again_choose_category2']       = '您的店铺没有绑定该分类，请重新选择分类。';
...
$lang['store_goods_step2_description_one']				= '上传商品默认主图，如多规格值时将默认使用该图或分规格上传各规格主图；支持jpg、gif、png格式上传或从图片空间中选择，建议使用<font color="red">尺寸800x800像素以上、大小不超过1M的正方形图片</font>，上传后的图片将会自动保存在图片空间的默认分类中。';
...
$lang['store_goods_brand_icon_null']			= '请上传品牌图标';
