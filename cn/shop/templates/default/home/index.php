...
<div class="wrapper">
  <div class="mt10"><div class="mt10">
    <a title="物流自提服务站广告" target="_blank" href="<?php echo DELIVERY_SITE_URL;?>">
      <img border="0" alt="物流自提服务站广告" src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_DELIVERY;?>/adv/banner.gif" style="width:1200px;height:100px">
    </a>
</div></div>
</div>
