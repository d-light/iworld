...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="index.php">首页</a> </span> <span class="arrow">></span> <span>线下团</span></div>
</div>
      ...
      <ul>
        ...
        <li class="<?php echo $output['current'];?>">
          ...
          <div class="item-prices"> <span class="price"><i><?php echo $lang['currency'];?></i><em><?php echo $groupbuy['groupbuy_price'];?></em></span>
            ...
            <span class="sold-num"> <em><?php echo $groupbuy['buyer_num'];?></em>次<?php echo $lang['text_buy'];?> </span> <a href="<?php echo urlShop('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$groupbuy['groupbuy_id']));?>" target="_blank" class="buy-button">我要团</a> </div>
        </li>
        <?php } ?>
      </ul>
    </div>
